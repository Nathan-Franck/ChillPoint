export namespace Texture {
	...
	export function create_element_buffer(gl: WebGL2RenderingContext, data: Uint16Array | Uint32Array) {
	...
	export function create_buffer(gl: WebGL2RenderingContext, data: ArrayBuffer) {
		const buffer = gl.createBuffer();
		if (buffer == null) {
			throw new Error("Buffer is null, this is not expected!");
		}
