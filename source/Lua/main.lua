...
do
    ...
    function FFI.load_library(args)
        local cdef_header = generate_cdef_header(args.functions)
...
do
    ...
    function Graphics2D.validate_sheet(sheet)
        return sheet
    end
...
local face = {{sprite = "eye.bmp", position = {x = -10, y = -8}}, {sprite = "eye.bmp", position = {x = 9, y = -4}}, {sprite = "mouth.bmp", position = {x = -4, y = 5}}}
