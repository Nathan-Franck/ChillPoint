...
do
    local FFIHeaderLookup = {uint = "int", ["char*"] = "const char*", ["const char*"] = "const char*", SDL_TimerCallback = "void*", SDL_bool = "bool", SDL_TimerID = "int", SDL_DisplayOrientation = "int", SDL_GLContext = "void*", SDL_GLattr = "int", Uint8 = "int", Uint32 = "int", Uint64 = "uint64_t", SDL_HitTest = "int", SDL_RendererFlip = "int", SDL_ScaleMode = "int", SDL_BlendMode = "int"}
...
local img = sdl_img.IMG_LoadTexture(renderer, "ball.png")
local result = sdl.SDL_RenderCopy(renderer, img, nil, nil)
sdl.SDL_Delay(2000)
print("done")
return ____exports
end,
